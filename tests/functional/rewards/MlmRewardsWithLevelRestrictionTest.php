...
class MlmRewardsWithLevelRestrictionTest extends \Codeception\Test\Unit
{
    /**
    ...
    public function _before()
    {
        ...
        $mlm->isLevelRestrictionAllowed = true;
    }
    ...
    public function testRewardsVerification()
    {
        ...
        verify($mlm->verifyRewards($_1->__mlmSubject()))->equals(3);
    }
    ...
    public function testAutorun()
    {
        ...
        verify($mlm->autorun(false))->equals([13, 4]);
    ...
    private static function expectedRewards($i)
    {
        $expected = [
            ...
            [
                ...
                'value' => 289.4628,
                'level' => 2,
                'status' => Mlm::RW_STATUS_MISSED,
                'status_reason' => Mlm::RWS_REASON_NOT_ELIGIBLE,
                'is_locked' => 0,
                'is_final' => 1,
                'approved_at' => null,
            ],
